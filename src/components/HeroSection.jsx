...
import liveDotIcon from "/src/assets/live-dot-icon.svg"
import folderIcon from "/src/assets/folder-icon.svg"
import shieldIcon from "/src/assets/shield-icon.svg"
      ...
      <div className="relative">
        <div className="container mx-auto text-center my-7 md:my-0 md:h-80 items-center flex flex-col justify-center gap-5">
          <div className="bg-[#ffffffcd] px-5 py-1 rounded-full shadow-[0px_4px_10px_0px_rgba(0,0,0,0.1)] w-fit flex items-center gap-2">
            <span><img src={liveDotIcon} alt="live-dot-icon" className="w-3" /></span>
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <div className="bg-[#ffffffcd] p-5 rounded-2xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.1)] flex items-center gap-2">
            <img src={folderIcon} alt="" className="w-10 h-10 p-2 rounded-lg bg-[#fce7f3]" />
          ...
          <div className="bg-[#ffffffcd] p-5 rounded-2xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.1)] flex items-center gap-2">
            <img src={shieldIcon} alt="" className="w-10 h-10 p-2 rounded-lg bg-[#e7fce7]" />
            <div className='text-[14px]'>
          ...
          <div className="bg-[#ffffffcd] p-5 rounded-2xl shadow-[0px_4px_10px_0px_rgba(0,0,0,0.1)] flex items-center gap-2">
            <img src={dashboardIcon} alt="" className="w-10 h-10 p-1 rounded-lg bg-[#ede9fe]" />
            <div className='text-[14px]'>
